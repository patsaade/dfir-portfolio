...
const STATIC_PAGES: IndexEntry[] = [
  ...
  { title: 'Accessibility', url: '/accessibility/', kind: 'Page', desc: 'Conformance target, what is verified automatically on every build, known limitations, and how to report a problem.', keywords: 'accessibility a11y wcag screen reader keyboard contrast reduced motion statement conformance' },
